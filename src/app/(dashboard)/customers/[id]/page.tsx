        ...
        <div className="mx-6 mt-4">
          <Card>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div><Label>نوع معامله موردنظر</Label><Select value={form.preferredDealType} onChange={(e) => setForm({ ...form, preferredDealType: e.target.value })} className="mt-1"><option value="">—</option><option value="SALE">فروش</option><option value="RENT">رهن و اجاره</option></Select></div>
