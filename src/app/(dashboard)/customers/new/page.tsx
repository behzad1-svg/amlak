    ...
    <div>
      ...
      <form onSubmit={submit} className="p-6 max-w-2xl space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div><Label>نوع معامله</Label><Select value={form.preferredDealType} onChange={(e) => upd("preferredDealType", e.target.value)} className="mt-1"><option value="">—</option><option value="SALE">فروش</option><option value="RENT">رهن و اجاره</option></Select></div>
